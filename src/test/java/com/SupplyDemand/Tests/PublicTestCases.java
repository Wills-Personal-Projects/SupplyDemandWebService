package com.SupplyDemand.Tests;

import com.SupplyDemand.SupplyDemandUtil;
// import SupplyDemand.jh61b.grader.GradedTest;
...
public class PublicTestCases {
    ...
    public void testSubPub() {
        ...
        sd.subscribe("target", "banana");
        sd.publish("dole", "banana", "dole");
        sd.subscribe("target", "applesauce");
        sd.publish("keurig drpepper", "applesauce", "mott's");
        sd.publish("chiquita", "banana", "chiquita");
        ...
        List<String> actual = sd.aggregateNotifs();
